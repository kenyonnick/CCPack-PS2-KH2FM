...
public static class CharacterAddresses {
    public static uint Sora = 0x21C6CC20; // 0x21CE0B68;   Potentially offset for Randomizer?
    ...
    public static uint ValorFormSora = 0x21C6CC28; // 0x21CE0B70;
    ...
    public static uint Donald = 0x21C6CC22; // 0x21CE0B6A;
    ...
    public static uint Goofy = 0x21C6CC24; // 0x21CE0B6C;
